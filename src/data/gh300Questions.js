...
export const gh300Questions = [
  ...
  },
  {
    ...
    choices: ["/explain", "/clarify function", "/debug", "/trace"],
    correct: [0],
    multiple: false,
  },
  {
  ...
  },
  {
    ...
    choices: ["Fairness.", "Accountability.", "Transparency.", "Exclusivity."],
    correct: [3],
    multiple: false,
  },
  {
  ...
  },
  {
    ...
    choices: ["Tab.", "Ctrl + Enter.", "Shift + Tab.", "Ctrl + Shift + S."],
    correct: [0],
    multiple: false,
  },
  {
    text: "What is the shortcut to accept a Copilot suggestion in VS Code?",
    choices: ["Tab.", "Ctrl + Space.", "Enter.", "Shift + Tab."],
    correct: [0],
    multiple: false,
  },
  {
  ...
  },
  {
    ...
    choices: ["Google.", "Amazon.", "Microsoft and OpenAI.", "Facebook."],
    correct: [2],
    multiple: false,
  },
  {
    text: "GitHub Copilot uses which AI model for code completion?",
    choices: ["GPT-2.", "Codex.", "Llama.", "Bert."],
    correct: [1],
    multiple: false,
  },
  {
  ...
  },
  {
    ...
    choices: ["/suggest code", "/optimize", "/generate docs", "/explain"],
    correct: [3],
    multiple: false,
  },
  {
